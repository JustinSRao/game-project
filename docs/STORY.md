...
Character names are **working placeholders** chosen so the docs can talk about them.
The project owner names the final characters; a rename is a find-and-replace plus an ADR.

- **KAITO** — the boy (placeholder name)
- **YUNA** — the girl (placeholder name)

---

## Premise

Kaito and Yuna are high-school seniors, next-door neighbors, childhood friends, and
...
One day, on their walk home from school, something happens. Yuna disappears.
...
2. **The last walk home.** The disappearance event. Scripted, identical for everyone,
   ...
   happened.
3. **The split.** The player chooses a path: play as Yuna, or play as Kaito.
...
## Path A — Yuna (isekai fantasy adventure)
...
- Yuna was **summoned** into a classic fantasy world: goblins, elves, royalty, magic,
  monsters, kingdoms.
- The reason: people from the human realm sometimes carry **dormant superpowers that
  only activate in the fantasy world**. Yuna's dormant power is the strongest ever
  detected.
- She was summoned by the **Villainess** — a powerful antagonist native to the fantasy
  ...
  evolve): to kill Yuna, to steal her power, or to use her.
- Yuna's overarching goal is fixed and unchangeable: **escape this world and return home**
  to her family and to Kaito. She never "settles in" permanently; the pull home is the
  spine of her arc.
...
## Path B — Kaito (emotional / psychological drama)
...
- When Yuna disappeared, **the world forgot her**. Reality reorganized: her parents have
  one less child and no memory of raising her; school records, photos, group chats — the
  world is seamless without her.
- **Only Kaito remembers.** No exceptions at the start of the path. (Whether he ever
...
- Kaito **does not know** she was transported to another world, and must not find out
...
- A solo playthrough of either path runs a **complete arc** with a real climax and a
  path ending — but the path ending is a **threshold, not a resolution**: Yuna reaches
  the way home but cannot cross alone; Kaito discovers the truth but cannot reach her
  alone.
- **The game can only be truly beaten in the Reunion**: a cross-platform multiplayer
  ...
  final act is generated from **both players' canon** — the allies Yuna made and the
  truths Kaito uncovered both matter in the finale, so every Reunion is unique to that
...
2. Never resolve the central mystery early. Kaito learning "she's in another world" is a
   late-game beat; Yuna finding a working way home is a late-game beat.
